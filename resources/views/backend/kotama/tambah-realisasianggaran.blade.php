  ...
  <div class="content-wrapper">
    <div class="container">
      ...
      <section class="content">
          ...
          <div class="box-body">
          	<a href="{{ URL('cms/kotama/realisasi-anggaran') }}" class="btn btn-xs btn-success margin-top-50"><i class="fa fa-list"></i> Lihat Daftar Program</a>
		    <a href="{{ URL('cms/kotama/realisasi-anggaran') }}" class="btn btn-xs btn-success margin-top-50"><i class="fa fa-list"></i> Lihat Pencairan</a>
