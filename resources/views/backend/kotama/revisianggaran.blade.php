            ...
            <div class="box-body">
              <div class="box box-solid">
                            ...
                            <div class="row">
                              <div class="col-md-3 padding-top-25">
                                <div class="form-group">
                                  <a href="{{ URL('cms/kotama/edit-semua-revisi-anggaran') }}" class="btn btn-block btn-success"><i class="fa fa-list"></i> Revisi Semua Anggaran</a>
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                ...
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                  <tr>
                    <td><a href="{{ URL('cms/kotama/revisi-anggaran-detail') }}">012.22.14 - Program Dukungan Kesiapan Matra Darat</a></td>
                    <td>132.991.912</td>
                    <td>1</td>
                    <td>1.132.991.912</td>
                    <td><a href="{{ URL('cms/kotama/edit-revisi-anggaran') }}" class="btn btn-block btn-info"><i class="fa fa-pencil"></i> Revisi </a></td>                  
                  </tr>
                  <tr>
