        ...
        <div class="box">
            ...
            <div class="box-body">
              <div class="padding-bottom-20">
                  <a href="{{ URL('cms/realisasi-anggaran') }}" class="btn btn-xs btn-success"><i class="fa fa-list"></i> Lihat Dafar Program</a>
                </div>
              <div class="box box-solid">
                <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <a href="{{ URL('cms/tambah-pencairan-dana') }}" class="btn btn-xs btn-success pull-right"><i class="fa fa-plus"></i> Tambah Pencairan Dana</a>
                    </div>
                  </div>
