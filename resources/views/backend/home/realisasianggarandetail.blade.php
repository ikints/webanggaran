        ...
        <div class="box">
            ...
            <div class="box-body">
              <div class="padding-bottom-20">
                  <a href="{{ URL('cms/realisasi-anggaran') }}" class="btn btn-success btn-flat"><i class="fa fa-list"></i> Lihat Dafar Realisasi Anggaran</a>
                  <a href="{{ URL('cms/tambah-pencairan-dana') }}" class="btn btn-success btn-flat"><i class="fa fa-plus"></i> Tambah Pencairan</a>
                </div>
