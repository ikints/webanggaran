      ...
      <section class="content">
        ...
        <div class="box">
            <div class="box-header padding-bottom-50 text-center">
              <h4 class="box-title">Realisasi Anggaran <br> Tahun 2019</h4><br>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="box box-solid">
                ...
                <div class="padding-bottom-20">
                  <a href="{{ URL('cms/tambah-realisasi-anggaran') }}" class="btn btn-xs btn-success"><i class="fa fa-plus"></i> Tambah Realisasi Dana Program</a>
                </div>
                ...
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                  <tr>
                    <td><a href="{{ URL('cms/realisasi-anggaran-detail') }}">012.22.14 - Program Dukungan Kesiapan Matra Darat</a></td>
                    <td>132.991.912</td>
                    <td>8.765.12</td>
