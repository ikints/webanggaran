            ...
            <div class="box-body">
              <div class="box box-solid">
                ...
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                  <tr>
                    <td><a href="{{ URL('cms/revisi-anggaran-detail') }}">012.22.14 - Program Dukungan Kesiapan Matra Darat</a></td>
                    <td>132.991.912</td>
                    <td>1</td>
                    <td>1.132.991.912</td>
                    <td><a href="{{ URL('cms/edit-revisi-anggaran') }}" class="btn btn-block btn-info"><i class="fa fa-pencil"></i> Revisi </a></td>                  
                  </tr>
                  <tr>
