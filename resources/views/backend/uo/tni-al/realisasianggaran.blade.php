                ...
                <div class="table-responsive text-nowrap">
                  <table class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <td>70.041.220.000</td>
                        <td>
                          <a href="{{ URL('cms/tni-al/uo/penyerapan-realisasi-anggaran') }}">Penyerapan</a> | <a href="{{ URL('cms/tni-al/uo/realisasi-anggaran-detail') }}">Detil</a> 
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- <a href="{{ URL('cms/tni-al/uo/rincian-anggaran-detail') }}">Kegiatan Pengamanan</a></td>
                        <td>19.00</td>
                        <td>GIAT</td>
                        <td>15.000</td>
                        <td>16.000.000</td>
                      ...
                      <tr>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- <a href="{{ URL('cms/tni-al/uo/rincian-anggaran-detail') }}">P4GN</a></td>
                        <td>19.00</td>
                        <td>GIAT</td>
                        <td>15.000</td>
                        <td>16.000.000</td>
