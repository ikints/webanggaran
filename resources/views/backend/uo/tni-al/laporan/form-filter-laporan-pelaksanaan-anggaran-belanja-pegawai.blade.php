  ...
  <div class="content-wrapper">
      ...
      <section class="content">
          ...
          <div class="box-header with-border text-center">
            <h3 class="box-title report-title">Laporan Pelaksanaan Anggaran Belanja Pegawai</h3><br>
          	...
          	<div class="row">
		        <div class="col-md-6 col-md-offset-3">
		            <div class="box-body margin-bottom-50 margin-top-10 box-form-rounded">
		            	...
		            	<!-- form start -->
			            <form class="form-horizontal" method="post" action="laporan-pelaksanaan-anggaran-belanja-pegawai">
			              {{ csrf_field() }}
			              <div class="box-body">
