        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="padding-bottom-20">
                  <a href="{{ URL('cms/tni-ad/uo/anggaran') }}" class="btn btn-xs btn-success"><i class="fa fa-list"></i> Anggaran Kementerian</a>
                  <a href="{{ URL('cms/tni-ad/uo/input-anggaran') }}" class="btn btn-xs btn-success"><i class="fa fa-plus"></i> Input Anggaran</a>
                </div>
