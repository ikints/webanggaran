      ...
      <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-header padding-bottom-10 text-center">
              <h4 class="box-title report-title">Laporan Pelaksanaan Perkembangan Pembangunan dan Fasilitas</h4><br>
                ...
                buttons: [
                    {
                      ...
                      action: function ( e, dt, node, config ) {
                          window.location = APP_URL + '/cms/kemhan/uo/form-filter-laporan-pelaksanaan-perkembangan-pembangunan-dan-fasilitas';
                      }
                    },
                    {   
                        ...
                        className: 'btn btn-success',
                        footer: true,
                        filename: 'Laporan Pelaksanaan Perkembangan Pembangunan dan Fasilitas \n Sampai dengan bulan : Desember 2019 \n {{Session::get('status_user')}}',
                        title:'',
                        ...
                        customize: function (xlsx) {
                          ...
                          //insert
                          var r1 = AddrowHead(1, [{ k: 'A', v: 'Laporan Pelaksanaan Perkembangan Pembangunan dan Fasilitas' }]);
                    ...
                    { 
                        ...
                        className: 'btn btn-success',
                        footer: true,
                        filename: 'Laporan Pelaksanaan Perkembangan Pembangunan dan Fasilitas {{Session::get('status_user')}} Sampai dengan bulan : Desember 2019',
                        title:'Laporan Pelaksanaan Perkembangan Pembangunan dan Fasilitas' + '\n' + 'Sampai dengan bulan : Desember 2019' + '\n' + ' {{Session::get('status_user')}} ',
                        orientation: 'landscape',
                        pageSize: 'A4',
