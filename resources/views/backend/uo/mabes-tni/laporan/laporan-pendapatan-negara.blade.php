      ...
      <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-header padding-bottom-10 text-center">
              <h4 class="box-title report-title">Laporan Pendapatan Negara</h4><br>
                ...
                buttons: [
                    {
                      ...
                      action: function ( e, dt, node, config ) {
                          window.location = APP_URL + '/cms/kemhan/uo/form-filter-laporan-pendapatan-negara';
                      }
                    },
                    {   
                    ...
                    { 
                        ...
                        className: 'btn btn-success',
                        footer: true,
                        filename: 'Laporan pendapatan negara {{Session::get('status_user')}} Sampai dengan bulan : Desember 2019',
