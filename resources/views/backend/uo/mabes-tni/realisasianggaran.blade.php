            ...
            <div class="box-body">
              <div class="box box-solid">
                ...
                <div class="padding-bottom-20">
                  <a href="{{ URL('cms/mabes-tni/uo/tambah-realisasi-anggaran') }}" class="btn btn-xs btn-success"><i class="fa fa-plus"></i> Tambah Realisasi Dana Program</a>
                </div>
                ...
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                  <tr>
                    <td><a href="{{ URL('cms/mabes-tni/uo/realisasi-anggaran-detail') }}">012.22.14 - Program Dukungan Kesiapan Matra Darat</a></td>
                    <td>132.991.912</td>
                    <td>8.765.12</td>
