        ...
        <div class="box">
            ...
            <div class="box-body">
              <form class="form">
                ...
                <div>
                  <a href="{{ URL('cms/tni-au/uo/tni-au/uo/tambah-realisasi-anggaran') }}" class="btn btn-success btn-flat"><i class="fa fa-plus"></i> Revisi Program</a>
                </div>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="{{ URL('cms/tni-au/uo/edit-realisasi-anggaran') }}">Edit</a> | <a href="#">Delete</a> | <a href="{{ URL('cms/tni-au/uo/rincian-anggaran-detail') }}">Riwayat</a>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- <a href="{{ URL('cms/tni-au/uo/tni-au/uo/rincian-anggaran-detail') }}">Kegiatan Pengamanan</a></td>
                        <td>19.00</td>
                        <td>GIAT</td>
                        <td>15.000</td>
                      ...
                      <tr id="anggaran-terlambat">
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- <a href="{{ URL('cms/tni-au/uo/tni-au/uo/rincian-anggaran-detail') }}">P4GN</a></td>
                        <td>19.00</td>
                        <td>GIAT</td>
                        <td>15.000</td>
                        <td class="progress-bar-custom progress-bar-green" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 20%">16.000.000</td>
